                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <form action="/v1/payments/stk/push" method="POST" class="space-y-6">
                                @csrf
                                
                                <div class="space-y-2">
                                    <label for="amount" class="text-sm font-medium text-gray-700">Amount (KES)</label>
                                    <input type="number" 
                                           name="amount" 
                                           id="amount"
                                           value="{{ old('amount') }}"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="tel" 
                                           ...
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('phonenumber') border-red-500 @enderror"
                                           placeholder="254XXXXXXXXX"
                                           pattern="254[0-9]{9}"
                                           title="Please enter phone number starting with 254"
                                           required>
                                    @error('phonenumber')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('account_number') border-red-500 @enderror"
